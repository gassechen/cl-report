...
var node = cljs_test_display.core.n.call(null,new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"id","id",-1388402092),"cljs-test-display-style"], null),style_string_19319);
...
var len__4864__auto___19323 = arguments.length;
var i__4865__auto___19324 = (0);
while(true){
if((i__4865__auto___19324 < len__4864__auto___19323)){
args__4870__auto__.push((arguments[i__4865__auto___19324]));

var G__19325 = (i__4865__auto___19324 + (1));
i__4865__auto___19324 = G__19325;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs_test_display.core.n.cljs$lang$applyTo = (function (seq19320){
...
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__19321,G__19322,seq19320__$2);
}));
...
var vec__19326 = ((clojure.string.starts_with_QMARK_.call(null,cljs.core.first.call(null,classes),"#"))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,cljs.core.first.call(null,classes),(1)),cljs.core.rest.call(null,classes)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,classes], null));
var id = cljs.core.nth.call(null,vec__19326,(0),null);
var classes__$1 = cljs.core.nth.call(null,vec__19326,(1),null);
var G__19329 = cljs.core.PersistentArrayMap.EMPTY;
var G__19329__$1 = (cljs.core.truth_(id)?cljs.core.assoc.call(null,G__19329,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__19329);
if(cljs.core.truth_(cljs.core.not_empty.call(null,classes__$1))){
return cljs.core.assoc.call(null,G__19329__$1,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.call(null," ",classes__$1));
} else {
return G__19329__$1;
}
} else {
...
return (function() { 
var G__19333__delegate = function (klass,contents){
var vec__19330 = (((klass instanceof cljs.core.Keyword))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [klass,contents], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,cljs.core.cons.call(null,klass,contents)], null));
var klass__$1 = cljs.core.nth.call(null,vec__19330,(0),null);
var contents__$1 = cljs.core.nth.call(null,vec__19330,(1),null);
...
var G__19333 = function (klass,var_args){
var contents = null;
if (arguments.length > 1) {
var G__19334__i = 0, G__19334__a = new Array(arguments.length -  1);
while (G__19334__i < G__19334__a.length) {G__19334__a[G__19334__i] = arguments[G__19334__i + 1]; ++G__19334__i;}
  contents = new cljs.core.IndexedSeq(G__19334__a,0,null);
} 
return G__19333__delegate.call(this,klass,contents);};
G__19333.cljs$lang$maxFixedArity = 1;
G__19333.cljs$lang$applyTo = (function (arglist__19335){
var klass = cljs.core.first(arglist__19335);
var contents = cljs.core.rest(arglist__19335);
return G__19333__delegate(klass,contents);
});
...
cljs_test_display.core.process_file_name = (function cljs_test_display$core$process_file_name(p__19339){
var map__19340 = p__19339;
var map__19340__$1 = cljs.core.__destructure_map.call(null,map__19340);
var ns = cljs.core.get.call(null,map__19340__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
var file = cljs.core.get.call(null,map__19340__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
cljs_test_display.core.comparison = (function cljs_test_display$core$comparison(p__19341){
var map__19342 = p__19341;
var map__19342__$1 = cljs.core.__destructure_map.call(null,map__19342);
var actual = cljs.core.get.call(null,map__19342__$1,new cljs.core.Keyword(null,"actual","actual",107306363));
var expected = cljs.core.get.call(null,map__19342__$1,new cljs.core.Keyword(null,"expected","expected",1583670997));
...
cljs_test_display.core.error_comparison = (function cljs_test_display$core$error_comparison(p__19343){
var map__19344 = p__19343;
var map__19344__$1 = cljs.core.__destructure_map.call(null,map__19344);
var expected = cljs.core.get.call(null,map__19344__$1,new cljs.core.Keyword(null,"expected","expected",1583670997));
var actual = cljs.core.get.call(null,map__19344__$1,new cljs.core.Keyword(null,"actual","actual",107306363));
...
cljs.core.swap_BANG_.call(null,cljs_test_display.core.state,cljs.core.update,new cljs.core.Keyword(null,"current-node","current-node",-814308842),(function (p1__19345_SHARP_){
return cljs.core.cons.call(null,new_current_node,p1__19345_SHARP_);
}));
...
var curr_node = cljs_test_display.core.current_node.call(null);
var map__19347 = cljs_test_display.core.current_var_info.call(null);
var map__19347__$1 = cljs.core.__destructure_map.call(null,map__19347);
var info = map__19347__$1;
var name = cljs.core.get.call(null,map__19347__$1,new cljs.core.Keyword(null,"name","name",1843675177));
var line = cljs.core.get.call(null,map__19347__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.call(null,map__19347__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
cljs.core.swap_BANG_.call(null,cljs_test_display.core.state,cljs.core.update,new cljs.core.Keyword(null,"current-node","current-node",-814308842),(function (p1__19346_SHARP_){
return cljs.core.cons.call(null,node,p1__19346_SHARP_);
}));

return goog.dom.appendChild(curr_node,node);
});
cljs_test_display.core.summary = (function cljs_test_display$core$summary(p__19348){
var map__19349 = p__19348;
var map__19349__$1 = cljs.core.__destructure_map.call(null,map__19349);
var m = map__19349__$1;
var fail = cljs.core.get.call(null,map__19349__$1,new cljs.core.Keyword(null,"fail","fail",1706214930));
var error = cljs.core.get.call(null,map__19349__$1,new cljs.core.Keyword(null,"error","error",-978969032));
var pass = cljs.core.get.call(null,map__19349__$1,new cljs.core.Keyword(null,"pass","pass",1574159993));
var test = cljs.core.get.call(null,map__19349__$1,new cljs.core.Keyword(null,"test","test",577538877));
...
var temp__5720__auto___19350 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5720__auto___19350)){
var message_19351 = temp__5720__auto___19350;
cljs.core.println.call(null,message_19351);
} else {
}
...
var temp__5720__auto___19352 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5720__auto___19352)){
var message_19353 = temp__5720__auto___19352;
cljs.core.println.call(null,message_19353);
} else {
}
