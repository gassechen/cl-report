...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq20375){
...
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__20376,G__20377,seq20375__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__20381_SHARP_){
return (!((cljs.core.meta.call(null,p1__20381_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.call(null,map__20382__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e20383){var _e__19624__auto__ = e20383;
return false;
}})();
if(cljs.core.truth_(or__4253__auto__)){
return or__4253__auto__;
...
}catch (e20385){var _e__19624__auto__ = e20385;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__20387 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__20388 = devtools.formatters.state.get_current_state.call(null);
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__20388);
...
var map__20389 = opts;
var map__20389__$1 = cljs.core.__destructure_map.call(null,map__20389);
var markup_db = cljs.core.get.call(null,map__20389__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__20387);
}});
...
var temp__5718__auto___20393 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5718__auto___20393)){
var managed_print_level_20394 = temp__5718__auto___20393;
var _STAR_print_level_STAR__orig_val__20391_20395 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__20392_20396 = managed_print_level_20394;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__20392_20396);

try{devtools.formatters.state.update_current_state_BANG_.call(null,(function (p1__20390_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__20390_SHARP_,null);
}));

job_fn.call(null);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__20391_20395);
}} else {
job_fn.call(null);
}
