...
var G__17547 = o;
reagent.impl.template.goog$module$goog$object.set.call(null,G__17547,reagent.impl.template.cached_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
while (G__17549__i < G__17549__a.length) {G__17549__a[G__17549__i] = arguments[G__17549__i + 0]; ++G__17549__i;}
  args = new cljs.core.IndexedSeq(G__17549__a,0,null);
} 
...
var G__17551 = o;
reagent.impl.template.goog$module$goog$object.set.call(null,G__17551,reagent.impl.template.cached_custom_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
if(cljs.core.ifn_QMARK_.call(null,x)){
return (function() { 
var G__17552__delegate = function (args){
return cljs.core.apply.call(null,x,args);
};
...
while (G__17553__i < G__17553__a.length) {G__17553__a[G__17553__i] = arguments[G__17553__i + 0]; ++G__17553__i;}
  args = new cljs.core.IndexedSeq(G__17553__a,0,null);
} 
return G__17552__delegate.call(this,args);};
...
return G__17552__delegate(args);
});
...
var G__17555 = props;
var G__17555__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__17555,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__17555);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__17555__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$,(function (){var or__4253__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class.call(null,(function (){var G__17556 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__17556,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$));
} else {
return G__17556;
}
})(),id_class);
...
var G__17557 = (cljs.core.count.call(null,argv) - first_child);
switch (G__17557) {
case (0):
...
var vec__17559 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__17559,(0),null);
var id = cljs.core.nth.call(null,vec__17559,(1),null);
var className = cljs.core.nth.call(null,vec__17559,(2),null);
...
var temp__5724__auto___17562 = reagent.impl.util.react_key_from_vec.call(null,v);
if((temp__5724__auto___17562 == null)){
} else {
var key_17563 = temp__5724__auto___17562;
(jsprops.key = key_17563);
}
...
var temp__5724__auto___17564 = reagent.impl.util.react_key_from_vec.call(null,v);
if((temp__5724__auto___17564 == null)){
} else {
var key_17565 = temp__5724__auto___17564;
(jsprops.key = key_17565);
}
...
var temp__5724__auto___17566 = reagent.impl.util.react_key_from_vec.call(null,argv);
if((temp__5724__auto___17566 == null)){
} else {
var key_17567 = temp__5724__auto___17566;
(jsprops.key = key_17567);
}
...
var temp__5724__auto___17568 = reagent.impl.util.get_react_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5724__auto___17568 == null)){
} else {
var key_17569 = temp__5724__auto___17568;
(jsprops.key = key_17569);
}
...
var temp__5724__auto___17570 = reagent.impl.util.get_react_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5724__auto___17570 == null)){
} else {
var key_17571 = temp__5724__auto___17570;
...
return cljs.core.into_array.call(null,cljs.core.map.call(null,(function (p1__17572_SHARP_){
return reagent.impl.protocols.as_element.call(null,compiler,p1__17572_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__17573 = reagent.ratom.check_derefs.call(null,(function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx,compiler);
}));
var res = cljs.core.nth.call(null,vec__17573,(0),null);
var derefed = cljs.core.nth.call(null,vec__17573,(1),null);
...
break;
default:
var G__17578 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
var G__17579 = compiler;
v = G__17578;
compiler = G__17579;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template17583 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template17583 = (function (opts,id,fn_to_element,parse_fn,meta17584){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template17583.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_17585,meta17584__$1){
var self__ = this;
var _17585__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template17583(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta17584__$1));
}));

(reagent.impl.template.t_reagent$impl$template17583.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_17585){
var self__ = this;
var _17585__$1 = this;
return self__.meta17584;
}));

(reagent.impl.template.t_reagent$impl$template17583.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template17583.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template17583.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
return self__.parse_fn.call(null,this$__$1,tag_name,tag_value);
}));

(reagent.impl.template.t_reagent$impl$template17583.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element.call(null,this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template17583.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element.call(null,this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template17583.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta17584","meta17584",-1825234974,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template17583.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template17583.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template17583");

(reagent.impl.template.t_reagent$impl$template17583.cljs$lang$ctorPrWriter = (function (this__4491__auto__,writer__4492__auto__,opt__4493__auto__){
return cljs.core._write.call(null,writer__4492__auto__,"reagent.impl.template/t_reagent$impl$template17583");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template17583.
 */
reagent.impl.template.__GT_t_reagent$impl$template17583 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template17583(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta17584){
return (new reagent.impl.template.t_reagent$impl$template17583(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta17584));
});

}

return (new reagent.impl.template.t_reagent$impl$template17583(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
