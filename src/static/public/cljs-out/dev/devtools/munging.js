...
var o20259 = temp__5718__auto__;
var temp__5718__auto____$1 = (o20259["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o20260 = temp__5718__auto____$1;
return (o20260["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__19617__auto__ = f;
return (o__19617__auto__["toString"]).call(o__19617__auto__);
} else {
return "";
}
}catch (e20261){var _ = e20261;
return "";
}});
...
try{var o__19617__auto___20263 = t;
(o__19617__auto___20263["cljs$lang$ctorPrWriter"]).call(o__19617__auto___20263,t,writer);
}catch (e20262){var __20264 = e20262;
}
...
var char_code = (function (){var o__19617__auto__ = (new String(char$));
return (o__19617__auto__["charCodeAt"]).call(o__19617__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__19617__auto__ = String;
return (o__19617__auto__["fromCharCode"]).call(o__19617__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__20265 = num_code;
switch (G__20265) {
case (1):
return (185);
...
var o__19617__auto__ = String;
return (o__19617__auto__["fromCharCode"]).call(o__19617__auto__,superscript_code);
});
/**
...
}catch (e20267){var _e__19624__auto__ = e20267;
return false;
}})())){
...
var vec__20268 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__20268,(0),null);
...
var len__4864__auto___20277 = arguments.length;
var i__4865__auto___20278 = (0);
while(true){
if((i__4865__auto___20278 < len__4864__auto___20277)){
args__4870__auto__.push((arguments[i__4865__auto___20278]));

var G__20279 = (i__4865__auto___20278 + (1));
i__4865__auto___20278 = G__20279;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__20273){
var vec__20274 = p__20273;
var ns_detector = cljs.core.nth.call(null,vec__20274,(0),null);
...
var G__20280 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__20281 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__20280;
remaining_tokens = G__20281;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq20271){
var G__20272 = cljs.core.first.call(null,seq20271);
var seq20271__$1 = cljs.core.next.call(null,seq20271);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__20272,seq20271__$1);
}));
...
var vec__20285 = cljs.core.split_with.call(null,(function (p1__20284_SHARP_){
return cljs.core.not_EQ_.call(null,p1__20284_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__20285,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__20285,(1),null);
...
var vec__20291 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__20291,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__20291,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__20294 = cljs.core.rest.call(null,remaining_tokens);
var G__20295 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__20294;
name_tokens = G__20295;
continue;
} else {
...
var vec__20298 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__20298,(0),null);
var arity = cljs.core.nth.call(null,vec__20298,(1),null);
var vec__20301 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__20301,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__20301,(1),null);
var vec__20304 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__20304,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__20304,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__20304,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__20304,(3),null);
...
var vec__20310 = result;
var munged_ns = cljs.core.nth.call(null,vec__20310,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__20310,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__20310,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__20310,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__20310,(4),null);
var arity = cljs.core.nth.call(null,vec__20310,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__20314 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__20314,(0),null);
var args = cljs.core.nth.call(null,vec__20314,(1),null);
var vec__20317 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__20317,(0),null);
var name = cljs.core.nth.call(null,vec__20317,(1),null);
...
var G__20320 = (arity + (1));
var G__20321 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__20322){
var vec__20323 = p__20322;
var arity = cljs.core.nth.call(null,vec__20323,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__20323,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__20326_SHARP_){
return cljs.core.get.call(null,arities,p1__20326_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__20327_SHARP_){
return cljs.core.drop.call(null,(2),p1__20327_SHARP_);
}),sorted_infos);
...
var args__4870__auto__ = [];
var len__4864__auto___20334 = arguments.length;
var i__4865__auto___20335 = (0);
while(true){
if((i__4865__auto___20335 < len__4864__auto___20334)){
args__4870__auto__.push((arguments[i__4865__auto___20335]));

var G__20336 = (i__4865__auto___20335 + (1));
i__4865__auto___20335 = G__20336;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__20330){
var vec__20331 = p__20330;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__20331,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq20328){
var G__20329 = cljs.core.first.call(null,seq20328);
var seq20328__$1 = cljs.core.next.call(null,seq20328);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__20329,seq20328__$1);
}));
...
var map__20339 = options;
var map__20339__$1 = cljs.core.__destructure_map.call(null,map__20339);
var include_ns_QMARK_ = cljs.core.get.call(null,map__20339__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__20339__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__20339__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__20339__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__20340 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__20340,(0),null);
var fn_name = cljs.core.nth.call(null,vec__20340,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__20340,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__20340,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__20340,(4),null);
var arity = cljs.core.nth.call(null,vec__20340,(5),null);
...
var o__19617__auto__ = f;
return (o__19617__auto__["getBasis"]).call(o__19617__auto__);
});
/**
...
}catch (e20343){var _e__19624__auto__ = e20343;
...
var G__20344 = (obj[cljs.core.first.call(null,path)]);
var G__20345 = cljs.core.rest.call(null,path);
obj = G__20344;
path = G__20345;
continue;
} else {
...
var _STAR_ = (function (accum,p__20346){
var vec__20347 = p__20346;
var bit = cljs.core.nth.call(null,vec__20347,(0),null);
var protocol = cljs.core.nth.call(null,vec__20347,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__20350){
var vec__20351 = p__20350;
var ns = cljs.core.nth.call(null,vec__20351,(0),null);
var name = cljs.core.nth.call(null,vec__20351,(1),null);
var selector = cljs.core.nth.call(null,vec__20351,(2),null);
...
var post_process = (function (p__20355){
var vec__20356 = p__20355;
var munged_name = cljs.core.nth.call(null,vec__20356,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__20356,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__20354_SHARP_){
return (obj[cljs.core.first.call(null,p1__20354_SHARP_)]);
}),sorted_matches);
