...
var G__20361 = devtools.prefs.pref.call(null,v);
v = G__20361;
continue;
} else {
return v;
...
}catch (e20362){var _e__19624__auto__ = e20362;
return false;
}})();
...
}catch (e20364){var _e__19624__auto__ = e20364;
return false;
}})();
...
}catch (e20366){var _e__19624__auto__ = e20366;
return false;
}}
}
});
...
var vec__20368 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__20368,(0),null);
...
return cljs.core.some.call(null,(function (p1__20371_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__20371_SHARP_);
}),template);
});
