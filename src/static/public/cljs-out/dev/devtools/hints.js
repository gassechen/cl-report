...
var map__21365 = top_item;
var map__21365__$1 = cljs.core.__destructure_map.call(null,map__21365);
var file = cljs.core.get.call(null,map__21365__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__21365__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__21365__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e21364){var _e = e21364;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5718__auto___21366 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5718__auto___21366)){
var seen_errors_21367 = temp__5718__auto___21366;
if(cljs.core.truth_(seen_errors_21367.has(self))){
} else {
seen_errors_21367.add(self);

var temp__5720__auto___21368 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5720__auto___21368)){
var sense_21369 = temp__5720__auto___21368;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_21369)].join(''));
} else {
}
}
} else {
