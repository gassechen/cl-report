...
var G__19229 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__19229,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__19229;
}
}));
...
/** @this {Function} */
(cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq19231){
...
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__19232,G__19233,seq19231__$2);
}));
...
var map__19238 = m;
var map__19238__$1 = cljs.core.__destructure_map.call(null,map__19238);
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,(function (p1__19237_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__19237_SHARP_));
...
var temp__5720__auto___19239 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5720__auto___19239)){
var message_19240 = temp__5720__auto___19239;
cljs.core.println.call(null,message_19240);
} else {
}
...
var temp__5720__auto___19241 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5720__auto___19241)){
var message_19242 = temp__5720__auto___19241;
cljs.core.println.call(null,message_19242);
} else {
}
...
var output_dir = "../static/public/cljs-out/dev";
var output_dir__$1 = (function (){var G__19243 = output_dir;
if((!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/")))){
return [G__19243,"/"].join('');
} else {
return G__19243;
}
})();
...
var G__19244 = exception.stack;
var G__19244__$1 = (((G__19244 == null))?null:clojure.string.split_lines.call(null,G__19244));
var G__19244__$2 = (((G__19244__$1 == null))?null:cljs.core.get.call(null,G__19244__$1,depth));
if((G__19244__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__19244__$2);
}
} else {
...
var vec__19245 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__19245,(0),null);
var column = cljs.core.nth.call(null,vec__19245,(1),null);
var vec__19248 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__19248,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__19248,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__19248,(2),null);
...
var m__$1 = (function (){var G__19251 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__19255 = (function (){var G__19254 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__19254);
} else {
return G__19254;
}
})();
...
return cljs.core.vary_meta.call(null,G__19256,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var vec__19260 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__19260,(0),null);
var types = vec__19260;
...
return cljs.core.map.call(null,(function (p__19263){
var vec__19264 = p__19263;
var ns = cljs.core.nth.call(null,vec__19264,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__19264,(1),null);
return (function (){
...
var G__19267 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
var G__19267__$1 = (((G__19267 instanceof cljs.core.Keyword))?G__19267.fqn:null);
switch (G__19267__$1) {
case "async":
...
var seq__19268 = cljs.core.seq.call(null,vars__$1);
var chunk__19269 = null;
var count__19270 = (0);
var i__19271 = (0);
while(true){
if((i__19271 < count__19270)){
var v = cljs.core._nth.call(null,chunk__19269,i__19271);
var temp__5720__auto___19273 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5720__auto___19273)){
var t_19274 = temp__5720__auto___19273;
each_fixture_fn.call(null,((function (seq__19268,chunk__19269,count__19270,i__19271,t_19274,temp__5720__auto___19273,v,each_fixture_fn,G__19267,G__19267__$1,env,once_fixtures,each_fixtures,vec__19264,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_19274)));
});})(seq__19268,chunk__19269,count__19270,i__19271,t_19274,temp__5720__auto___19273,v,each_fixture_fn,G__19267,G__19267__$1,env,once_fixtures,each_fixtures,vec__19264,ns,vars__$1))
);
} else {
}


var G__19275 = seq__19268;
var G__19276 = chunk__19269;
var G__19277 = count__19270;
var G__19278 = (i__19271 + (1));
seq__19268 = G__19275;
chunk__19269 = G__19276;
count__19270 = G__19277;
i__19271 = G__19278;
continue;
} else {
var temp__5720__auto__ = cljs.core.seq.call(null,seq__19268);
if(temp__5720__auto__){
var seq__19268__$1 = temp__5720__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__19268__$1)){
var c__4679__auto__ = cljs.core.chunk_first.call(null,seq__19268__$1);
var G__19279 = cljs.core.chunk_rest.call(null,seq__19268__$1);
var G__19280 = c__4679__auto__;
var G__19281 = cljs.core.count.call(null,c__4679__auto__);
var G__19282 = (0);
seq__19268 = G__19279;
chunk__19269 = G__19280;
count__19270 = G__19281;
i__19271 = G__19282;
continue;
} else {
var v = cljs.core.first.call(null,seq__19268__$1);
var temp__5720__auto___19283__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5720__auto___19283__$1)){
var t_19284 = temp__5720__auto___19283__$1;
each_fixture_fn.call(null,((function (seq__19268,chunk__19269,count__19270,i__19271,t_19284,temp__5720__auto___19283__$1,v,seq__19268__$1,temp__5720__auto__,each_fixture_fn,G__19267,G__19267__$1,env,once_fixtures,each_fixtures,vec__19264,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_19284)));
});})(seq__19268,chunk__19269,count__19270,i__19271,t_19284,temp__5720__auto___19283__$1,v,seq__19268__$1,temp__5720__auto__,each_fixture_fn,G__19267,G__19267__$1,env,once_fixtures,each_fixtures,vec__19264,ns,vars__$1))
);
} else {
}


var G__19285 = cljs.core.next.call(null,seq__19268__$1);
var G__19286 = null;
var G__19287 = (0);
var G__19288 = (0);
seq__19268 = G__19285;
chunk__19269 = G__19286;
count__19270 = G__19287;
i__19271 = G__19288;
continue;
}
} else {
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__19267__$1)].join('')));
